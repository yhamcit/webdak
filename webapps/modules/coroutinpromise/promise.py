...
class Promise(Future, metaclass=MetaPromise):
    ...
    def __new__(cls, identifier: PromiseIdentifier):
    ...
    def __init__(self, identifier: PromiseIdentifier) -> None:
        self._identifier = identifier

    @property
    def identifier(self) -> PromiseIdentifier:
        return self._identifier
    
    @identifier.setter
    def identifier(self, identifier: PromiseIdentifier) -> None:
        self._identifier = identifier
